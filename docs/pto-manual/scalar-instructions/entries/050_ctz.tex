...
\subsection{\texttt{CTZ}}
\label{sec:scalar-ctz}
\index{CTZ@\texttt{CTZ}}
\begin{sloppypar}\noindent\textbf{Purpose.} Count trailing zeros.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
ctz SrcL,  M, N, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_ctz.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................100.....1100111}.
\end{description}
