...
\subsection{\texttt{SUBW}}
\label{sec:scalar-subw}
\index{SUBW@\texttt{SUBW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) integer subtraction.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
subw SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_subw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................001.....0100101}.
\end{description}
