...
\subsection{\texttt{CMP.AND}}
\label{sec:scalar-cmp_and}
\index{CMP.AND@\texttt{CMP.AND}}
\begin{sloppypar}\noindent\textbf{Purpose.} Tests whether the bitwise AND of SrcL and the modified SrcR is nonzero, then writes 1 or 0 to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
cmp.and SrcL, SrcR<.sw, .uw, .not>, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_cmp_and.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{00000............010.....1000101}.
\end{description}
