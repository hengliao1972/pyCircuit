...
\subsection{\texttt{SW.AND}}
\label{sec:scalar-sw_and}
\index{SW.AND@\texttt{SW.AND}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sw_and.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0001.0...........011000000001011}.
\end{description}
