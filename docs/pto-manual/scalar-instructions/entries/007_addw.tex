...
\subsection{\texttt{ADDW}}
\label{sec:scalar-addw}
\index{ADDW@\texttt{ADDW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) integer addition.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
addw SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_addw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................000.....0100101}.
\end{description}
