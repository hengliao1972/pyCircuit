...
\subsection{\texttt{DIVW}}
\label{sec:scalar-divw}
\index{DIVW@\texttt{DIVW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) integer division (signed).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
divw SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_divw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0000000..........010.....1010111}.
\end{description}
