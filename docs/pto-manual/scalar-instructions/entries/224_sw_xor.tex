...
\subsection{\texttt{SW.XOR}}
\label{sec:scalar-sw_xor}
\index{SW.XOR@\texttt{SW.XOR}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sw_xor.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0011.0...........011000000001011}.
\end{description}
