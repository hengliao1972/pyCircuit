...
\subsection{\texttt{BWI}}
\label{sec:scalar-bwi}
\index{BWI@\texttt{BWI}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_bwi.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{000000000010.....000000000101011}.
\end{description}
