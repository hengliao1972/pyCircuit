...
\subsection{\texttt{FMAX}}
\label{sec:scalar-fmax}
\index{FMAX@\texttt{FMAX}}
\begin{sloppypar}\noindent\textbf{Purpose.} Selects the larger floating-point operand and writes it to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
fmax.{T} SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_fmax.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{00000............110.....1011011}.
\end{description}
