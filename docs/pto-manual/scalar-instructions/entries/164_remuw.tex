...
\subsection{\texttt{REMUW}}
\label{sec:scalar-remuw}
\index{REMUW@\texttt{REMUW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) integer remainder (unsigned).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
remuw SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_remuw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0000000..........111.....1010111}.
\end{description}
