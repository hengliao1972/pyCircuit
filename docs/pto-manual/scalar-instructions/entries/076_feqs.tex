...
\subsection{\texttt{FEQS}}
\label{sec:scalar-feqs}
\index{FEQS@\texttt{FEQS}}
\begin{sloppypar}\noindent\textbf{Purpose.} Performs a signaling floating-point equality comparison and writes 1 or 0 to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
feqs.{T} SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_feqs.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{00001............000.....1011011}.
\end{description}
