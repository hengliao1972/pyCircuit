...
\subsection{\texttt{SD.XOR}}
\label{sec:scalar-sd_xor}
\index{SD.XOR@\texttt{SD.XOR}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sd_xor.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0011.0...........101000000001011}.
\end{description}
