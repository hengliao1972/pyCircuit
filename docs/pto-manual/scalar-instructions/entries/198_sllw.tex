...
\subsection{\texttt{SLLW}}
\label{sec:scalar-sllw}
\index{SLLW@\texttt{SLLW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) logical left shift.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
sllw SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sllw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0000000..........111.....0100101}.
\end{description}
