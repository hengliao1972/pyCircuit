...
\subsection{\texttt{CMP.GE}}
\label{sec:scalar-cmp_ge}
\index{CMP.GE@\texttt{CMP.GE}}
\begin{sloppypar}\noindent\textbf{Purpose.} Performs a signed greater-than-or-equal comparison between SrcL and SrcR and writes 1 or 0 to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
cmp.ge SrcL, SrcR<{.sw, .uw}>, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_cmp_ge.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{00000............101.....1000101}.
\end{description}
