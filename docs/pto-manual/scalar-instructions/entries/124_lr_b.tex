...
\subsection{\texttt{LR.B}}
\label{sec:scalar-lr_b}
\index{LR.B@\texttt{LR.B}}
...
lr.b<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_lr_b.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0000.............000.....0001011}.
\end{description}
