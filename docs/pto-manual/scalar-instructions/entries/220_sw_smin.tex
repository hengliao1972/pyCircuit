...
\subsection{\texttt{SW.SMIN}}
\label{sec:scalar-sw_smin}
\index{SW.SMIN@\texttt{SW.SMIN}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sw_smin.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0101.0...........011000000001011}.
\end{description}
