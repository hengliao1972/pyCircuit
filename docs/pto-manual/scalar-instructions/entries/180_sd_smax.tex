...
\subsection{\texttt{SD.SMAX}}
\label{sec:scalar-sd_smax}
\index{SD.SMAX@\texttt{SD.SMAX}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sd_smax.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0100.0...........101000000001011}.
\end{description}
