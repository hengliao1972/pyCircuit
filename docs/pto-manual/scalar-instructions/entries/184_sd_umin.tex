...
\subsection{\texttt{SD.UMIN}}
\label{sec:scalar-sd_umin}
\index{SD.UMIN@\texttt{SD.UMIN}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sd_umin.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0111.0...........101000000001011}.
\end{description}
