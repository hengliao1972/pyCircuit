...
\label{sec:scalar-b_ne}
\index{B.NE@\texttt{B.NE}}
\begin{sloppypar}\noindent\textbf{Purpose.} Conditional branch. The branch is taken when the selected condition holds (not equal).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
b.ne SrcL, SrcR, label
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_b_ne.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................001.....0100111}.
\end{description}
