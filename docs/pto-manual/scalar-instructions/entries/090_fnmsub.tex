...
\subsection{\texttt{FNMSUB}}
\label{sec:scalar-fnmsub}
\index{FNMSUB@\texttt{FNMSUB}}
\begin{sloppypar}\noindent\textbf{Purpose.} Negates the product of two floating-point operands, adds SrcA as a fused operation, and writes the rounded result to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
fnmsub.{T} SrcL, SrcR, SrcA, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_fnmsub.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................111.....1001011}.
\end{description}
