...
\subsection{\texttt{SD.SMIN}}
\label{sec:scalar-sd_smin}
\index{SD.SMIN@\texttt{SD.SMIN}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sd_smin.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0101.0...........101000000001011}.
\end{description}
