...
\subsection{\texttt{SD.UMAX}}
\label{sec:scalar-sd_umax}
\index{SD.UMAX@\texttt{SD.UMAX}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sd_umax.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0110.0...........101000000001011}.
\end{description}
