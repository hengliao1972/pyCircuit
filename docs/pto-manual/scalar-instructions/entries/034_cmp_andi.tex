...
\subsection{\texttt{CMP.ANDI}}
\label{sec:scalar-cmp_andi}
\index{CMP.ANDI@\texttt{CMP.ANDI}}
\begin{sloppypar}\noindent\textbf{Purpose.} Tests whether the bitwise AND of SrcL and the immediate operand is nonzero, then writes 1 or 0 to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
cmp.andi SrcL, simm, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_cmp_andi.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................010.....1010101}.
\end{description}
