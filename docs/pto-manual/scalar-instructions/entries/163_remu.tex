...
\subsection{\texttt{REMU}}
\label{sec:scalar-remu}
\index{REMU@\texttt{REMU}}
\begin{sloppypar}\noindent\textbf{Purpose.} Integer remainder (unsigned).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
remu SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_remu.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0000000..........101.....1010111}.
\end{description}
