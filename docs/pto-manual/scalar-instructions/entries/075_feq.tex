...
\subsection{\texttt{FEQ}}
\label{sec:scalar-feq}
\index{FEQ@\texttt{FEQ}}
\begin{sloppypar}\noindent\textbf{Purpose.} Floating-point equal comparison; writes a boolean result to the selected destination.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
feq.{T} SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_feq.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{00000............000.....1011011}.
\end{description}
