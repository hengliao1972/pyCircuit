...
\subsection{\texttt{SLLI}}
\label{sec:scalar-slli}
\index{SLLI@\texttt{SLLI}}
\begin{sloppypar}\noindent\textbf{Purpose.} Logical left shift (immediate).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
slli SrcL, shamt, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_slli.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{000000...........111.....0010101}.
\end{description}
