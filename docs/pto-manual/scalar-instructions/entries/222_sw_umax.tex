...
\subsection{\texttt{SW.UMAX}}
\label{sec:scalar-sw_umax}
\index{SW.UMAX@\texttt{SW.UMAX}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sw_umax.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0110.0...........011000000001011}.
\end{description}
