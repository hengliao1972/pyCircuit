...
\subsection{\texttt{SCVTF}}
\label{sec:scalar-scvtf}
\index{SCVTF@\texttt{SCVTF}}
\begin{sloppypar}\noindent\textbf{Purpose.} Converts a signed integer source value to the selected floating-point destination format.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
scvtf.{srcT2dstT} SrcL, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_scvtf.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.......00000.....110.....1101011}.
\end{description}
