...
\subsection{\texttt{REV}}
\label{sec:scalar-rev}
\index{REV@\texttt{REV}}
\begin{sloppypar}\noindent\textbf{Purpose.} Bit-reversal operation.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
rev SrcL,  M, N, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_rev.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................111.....1100111}.
\end{description}
...
\item[\texttt{immr}] Bits \texttt{31:26 (6b)}. 6-bit unsigned immediate operand consumed directly by the operation.
\end{description}
