...
\subsection{\texttt{BXS}}
\label{sec:scalar-bxs}
\index{BXS@\texttt{BXS}}
\begin{sloppypar}\noindent\textbf{Purpose.} Bit-field extract (signed).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
bxs SrcL, M, N, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_bxs.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................000.....1100111}.
\end{description}
