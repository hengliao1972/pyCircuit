...
\subsection{\texttt{CMP.OR}}
\label{sec:scalar-cmp_or}
\index{CMP.OR@\texttt{CMP.OR}}
\begin{sloppypar}\noindent\textbf{Purpose.} Tests whether the bitwise OR of SrcL and the modified SrcR is nonzero, then writes 1 or 0 to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
cmp.or SrcL, SrcR<.sw, .uw, .not>, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_cmp_or.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{00000............011.....1000101}.
\end{description}
