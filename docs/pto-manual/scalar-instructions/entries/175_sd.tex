...
\label{sec:scalar-sd}
\index{SD@\texttt{SD}}
\begin{sloppypar}\noindent\textbf{Purpose.} Stores a 64-bit value to memory using register-offset addressing.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
sd SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<3]
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sd.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................011000001001001}.
\end{description}
