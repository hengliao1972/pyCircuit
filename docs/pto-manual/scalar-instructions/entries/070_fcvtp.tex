...
\subsection{\texttt{FCVTP}}
\label{sec:scalar-fcvtp}
\index{FCVTP@\texttt{FCVTP}}
\begin{sloppypar}\noindent\textbf{Purpose.} Converts SrcL between encoded numeric formats using round-toward-plus-infinity and writes the result to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
fcvtp.{srcT2dstT} SrcL, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_fcvtp.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.......00000.....100.....1101011}.
\end{description}
