...
\subsection{\texttt{SD.AND}}
\label{sec:scalar-sd_and}
\index{SD.AND@\texttt{SD.AND}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sd_and.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0001.0...........101000000001011}.
\end{description}
