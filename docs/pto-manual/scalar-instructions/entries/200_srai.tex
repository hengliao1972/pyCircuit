...
\subsection{\texttt{SRAI}}
\label{sec:scalar-srai}
\index{SRAI@\texttt{SRAI}}
\begin{sloppypar}\noindent\textbf{Purpose.} Arithmetic right shift (immediate).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
srai SrcL, shamt, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_srai.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{000000...........110.....0010101}.
\end{description}
