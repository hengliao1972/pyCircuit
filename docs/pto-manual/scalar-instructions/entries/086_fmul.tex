...
\subsection{\texttt{FMUL}}
\label{sec:scalar-fmul}
\index{FMUL@\texttt{FMUL}}
\begin{sloppypar}\noindent\textbf{Purpose.} Multiplies two floating-point operands of type T and writes the rounded result to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
fmul.{T} SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_fmul.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{00000............010.....1001011}.
\end{description}
