...
\subsection{\texttt{ANDIW}}
\label{sec:scalar-andiw}
\index{ANDIW@\texttt{ANDIW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) AND-immediate.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
andiw SrcL, simm, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_andiw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................010.....0110101}.
\end{description}
