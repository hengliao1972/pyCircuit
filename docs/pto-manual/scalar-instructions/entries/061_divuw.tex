...
\subsection{\texttt{DIVUW}}
\label{sec:scalar-divuw}
\index{DIVUW@\texttt{DIVUW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) integer division (unsigned).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
divuw SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_divuw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0000000..........011.....1010111}.
\end{description}
