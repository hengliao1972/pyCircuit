...
\subsection{\texttt{MADDW}}
\label{sec:scalar-maddw}
\index{MADDW@\texttt{MADDW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) multiply-add (three-source).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
maddw SrcL, SrcR, SrcD, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_maddw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.....00..........111.....1000111}.
\end{description}
