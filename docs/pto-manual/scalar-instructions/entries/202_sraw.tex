...
\subsection{\texttt{SRAW}}
\label{sec:scalar-sraw}
\index{SRAW@\texttt{SRAW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) arithmetic right shift.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
sraw SrcL, SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sraw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0000000..........110.....0100101}.
\end{description}
