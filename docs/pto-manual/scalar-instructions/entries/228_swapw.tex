...
\subsection{\texttt{SWAPW}}
\label{sec:scalar-swapw}
\index{SWAPW@\texttt{SWAPW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Atomic swap: atomically exchanges a memory value with a register value and returns the old value.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
swapw<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_swapw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0010.............110.....0001011}.
\end{description}
