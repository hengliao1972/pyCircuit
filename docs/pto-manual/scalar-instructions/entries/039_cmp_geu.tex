...
\subsection{\texttt{CMP.GEU}}
\label{sec:scalar-cmp_geu}
\index{CMP.GEU@\texttt{CMP.GEU}}
\begin{sloppypar}\noindent\textbf{Purpose.} Performs an unsigned greater-than-or-equal comparison between SrcL and SrcR and writes 1 or 0 to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
cmp.geu SrcL, SrcR<{.sw, .uw}>, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_cmp_geu.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{00000............111.....1000101}.
\end{description}
