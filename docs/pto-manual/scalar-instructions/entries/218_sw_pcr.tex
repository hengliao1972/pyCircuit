...
\subsection{\texttt{SW.PCR}}
\label{sec:scalar-sw_pcr}
\index{SW.PCR@\texttt{SW.PCR}}
\begin{sloppypar}\noindent\textbf{Purpose.} Stores a 32-bit value to memory using PC-relative/symbol addressing.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
sw.pcr SrcL, [symbol]
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sw_pcr.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................010.....1101001}.
\end{description}
