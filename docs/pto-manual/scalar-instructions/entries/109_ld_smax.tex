...
\subsection{\texttt{LD.SMAX}}
\label{sec:scalar-ld_smax}
\index{LD.SMAX@\texttt{LD.SMAX}}
...
ld.smax<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_ld_smax.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0100.............100.....0001011}.
\end{description}
