...
\subsection{\texttt{SW.U}}
\label{sec:scalar-sw_u}
\index{SW.U@\texttt{SW.U}}
\begin{sloppypar}\noindent\textbf{Purpose.} Stores a 32-bit value to memory using unscaled register-offset addressing.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
sw.u SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>]
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sw_u.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................110000001001001}.
\end{description}
