...
\subsection{\texttt{BCNT}}
\label{sec:scalar-bcnt}
\index{BCNT@\texttt{BCNT}}
\begin{sloppypar}\noindent\textbf{Purpose.} Population count (count set bits).\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
bcnt srcL,  M, N, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_bcnt.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................110.....1100111}.
\end{description}
