...
\subsection{\texttt{SD.ADD}}
\label{sec:scalar-sd_add}
\index{SD.ADD@\texttt{SD.ADD}}
...
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_sd_add.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{0000.0...........101000000001011}.
\end{description}
