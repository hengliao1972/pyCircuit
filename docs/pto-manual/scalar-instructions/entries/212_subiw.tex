...
\subsection{\texttt{SUBIW}}
\label{sec:scalar-subiw}
\index{SUBIW@\texttt{SUBIW}}
\begin{sloppypar}\noindent\textbf{Purpose.} Word (32-bit) subtract-immediate.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
subiw SrcL, uimm, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_subiw.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................001.....0110101}.
\end{description}
