...
\subsection{\texttt{FMADD}}
\label{sec:scalar-fmadd}
\index{FMADD@\texttt{FMADD}}
\begin{sloppypar}\noindent\textbf{Purpose.} Multiplies two floating-point operands, adds SrcA as a fused operation, and writes the rounded result to RegDst.\end{sloppypar}\smallskip
\noindent\textbf{Syntax.}\par
\begin{lstlisting}[style=ptoscalarcode]
fmadd.{T} SrcL, SrcR, SrcA, ->RegDst
\end{lstlisting}
\noindent\textbf{Encoding.}\par
\noindent\includegraphics[width=\textwidth]{figs/encoding/scalar_instruction_entries/enc_fmadd.pdf}\par\smallskip
\begin{description}[leftmargin=0.18\linewidth,style=nextline]
\item[Format] \texttt{L32} \texttt{32-bit} scalar word.
\item[Pattern] \texttt{.................100.....1001011}.
\end{description}
